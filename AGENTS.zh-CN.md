...
5. 产品范围改动先读 `docs/product/agent-os-prd.md`
6. Agent OS 设计改动先读 `docs/agent-os/README.md`
7. 迁移任务先读 `docs/plans/active/monorepo-migration.md`
8. 目标 package README 或 manifest
9. `docs/engineering/` 或 `docs/operations/` 下相关文档
