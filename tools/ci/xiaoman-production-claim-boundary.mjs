...
const negatedClaimPattern =
  /\b(?:not|never|must not|do not|does not|cannot|can't|is not|isn't|remain(?:s)?|missing|blocked|incomplete|not complete|not production[- ]complete)\b|未|不|不能|尚未|缺失|未完成|不可|没有/iu;
