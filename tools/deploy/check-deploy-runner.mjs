...
if (exists(".github/workflows/run-production-runtime-one-shot.yml")) {
  ...
  for (const fragment of [
    ...
    "release_sha must be a lowercase 40-character git SHA.",
    "git merge-base --is-ancestor",
    "xiaoman-daily-case-report-auto-publish-backfill,xiaoman-daily-case-report-approval-repair,xiaoman-daily-case-report-read-through-repair,xiaoman-daily-case-report-chat-id-repair,xiaoman-creative-profile-candidates-apply,erhua-morning-brief,hermes-cron-snapshot-install",
