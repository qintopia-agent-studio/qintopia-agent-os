...
# exercises. Keep Huabaosi image-provider-only values out of the QiWe child process,
# but pass the shared Feishu primary-storage delivery boundary that QiWe validates
# and uses to read the approved JPEG.
