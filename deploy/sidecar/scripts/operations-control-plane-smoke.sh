...
assert_json "$capabilities" "data['capability_count'] == 13"
...
assert_json "$capabilities" "any(item['capability_key'] == 'xiaoman.material_followup_request' and item['provider_agent'] == 'xiaoman' and item['allowed_work_item_types'] == ['activity_recap_request'] for item in data['capabilities'])"
assert_json "$capabilities" "any(item['capability_key'] == 'xiaoman.notify_conversation' and item['provider_agent'] == 'xiaoman' and item['allowed_work_item_types'] == ['conversation_notification_request'] and item['review_policy'] == 'origin_conversation_only' for item in data['capabilities'])"
...
assert_json "$capabilities" "any(item['capability_key'] == 'erhua.manage_space_configuration' and item['enabled'] is False and item['review_policy'] == 'space_admin_confirmation' for item in data['capabilities'])"
assert_json "$capabilities" "any(item['capability_key'] == 'erhua.execute_space_business' and item['enabled'] is False and item['allowed_callers'] == ['erhua', 'system'] and item['allowed_work_item_types'] == ['space_automation_run', 'space_event_shadow_observation'] for item in data['capabilities'])"
assert_json "$capabilities" "any(item['capability_key'] == 'erhua.qiwe_text_template' and item['enabled'] is False and item['allowed_callers'] == ['system'] and item['allowed_work_item_types'] == ['space_automation_run'] for item in data['capabilities'])"
assert_json "$capabilities" "any(item['capability_key'] == 'erhua.space_agent_turn' and item['enabled'] is False and item['allowed_callers'] == ['system'] and item['allowed_work_item_types'] == ['space_agent_turn'] for item in data['capabilities'])"
assert_json "$capabilities" "any(item['capability_key'] == 'erhua.space_subject_identity_lookup' and item['enabled'] is False and item['risk_level'] == 'low' and item['allowed_callers'] == ['erhua'] and item['allowed_work_item_types'] == ['space_agent_turn'] for item in data['capabilities'])"
