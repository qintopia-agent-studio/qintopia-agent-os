...
assert_json "$capabilities" "data['capability_count'] == 9"
assert_json "$capabilities" "any(item['capability_key'] == 'resident_welcome.coordinate' and item['allowed_callers'] == [] for item in data['capabilities'])"
