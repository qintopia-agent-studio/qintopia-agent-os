...
assert_json "$xiaoman_status_tree" "data['descendant_count'] == 4"
...
assert_json "$xiaoman_status_tree" "any(item['work_item_id'] == '${xiaoman_image_work_item_id}' and item['parent_work_item_id'] == '${xiaoman_promotion_visual_child_id}' and item['work_item_type'] == 'image_generation_request' and item['depth'] == 2 for item in data['descendants'])"
...
xiaoman_nested_status_tree="$(run_json xiaoman_nested_status_tree operations-work-item-status --work-item-id "$xiaoman_image_work_item_id")"
assert_json "$xiaoman_nested_status_tree" "data['success'] is True"
assert_json "$xiaoman_nested_status_tree" "data['queried_work_item_id'] == '${xiaoman_image_work_item_id}'"
assert_json "$xiaoman_nested_status_tree" "data['root_work_item_id'] == '${xiaoman_worker_parent_id}'"
assert_json "$xiaoman_nested_status_tree" "data['child_count'] == 3"
assert_json "$xiaoman_nested_status_tree" "data['descendant_count'] == 4"
assert_json "$xiaoman_nested_status_tree" "any(item['work_item_id'] == '${xiaoman_image_work_item_id}' and item['depth'] == 2 for item in data['descendants'])"

xiaoman_nested_workflow_sync="$(run_json xiaoman_nested_workflow_sync operations-workflow-sync --work-item-id "$xiaoman_image_work_item_id" --dry-run)"
assert_json "$xiaoman_nested_workflow_sync" "data['success'] is True"
assert_json "$xiaoman_nested_workflow_sync" "data['root_work_item_id'] == '${xiaoman_worker_parent_id}'"
assert_json "$xiaoman_nested_workflow_sync" "data['child_count'] == 3"
assert_json "$xiaoman_nested_workflow_sync" "data['descendant_count'] == 4"
assert_json "$xiaoman_nested_workflow_sync" "len(data['child_status_refs']) == 3"
assert_json "$xiaoman_nested_workflow_sync" "len(data['descendant_status_refs']) == 4"
...
assert_json "$status_tree" "data['descendant_count'] == 3"
...
assert_json "$workflow_sync_dry" "data['descendant_count'] == 3"
assert_json "$workflow_sync_dry" "len(data['descendant_status_refs']) == 3"
