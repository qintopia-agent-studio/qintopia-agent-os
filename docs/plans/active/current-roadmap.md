...
- Use [Production current status](../../operations/production-current-status.md) as the
  short sanitized index for current Release, Hermes cron live apply, enablement,
  snapshot sync, and immediate operator actions.
