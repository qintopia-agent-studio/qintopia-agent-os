...
again from the latest successful deployed Release tag to the current Release tag, with a
fallback to the previous published Release tag when workflow history cannot prove a live
baseline.
