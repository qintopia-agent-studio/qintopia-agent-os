...
`be30c6feef7c9ea5e5d1916a88dd0277f885d8eb56ed0ade88864bc368a97502`, while the `v0.2.36`
Huabaosi staging sidecar contained only the earlier reviewed hash
...
`database URL hash is not in the reviewed allowlist`. No image, Feishu record, or QiWe
request was created by that failed attempt.
